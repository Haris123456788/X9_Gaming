...
if (isset($_POST['submit'])) {
    ...
    // Prepare SQL query
    $sql = "INSERT INTO `slider` (`name_short`, `name_long`, `description`, `banner_img`) 
            VALUES ('$name_short', '$name_long', '$description', '$banner_img')";
        ...
        <div class="form-container">
            ...
            <form method="POST" style=" padding: 30px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name_short" name="name_short" placeholder="Enter your short name">
                </div>

                <!-- Name Long Field -->
                <div class="form-group">
                    <label for="name_long">Name Long:</label>
                    <input type="text" class="form-control" id="name_long" name="name_long" placeholder="Enter your long name">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="banner_img" name="banner_img" placeholder="path e.g banner.jpg">
                </div>
